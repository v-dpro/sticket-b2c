// ONBOARDING · ABOUT YOU — kept minimal. Not part of the app/index gate
// flow; retained as a single clean, optional screen so the route compiles.
    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.body}>
        <Animated.View entering={FadeInDown.duration(300)} style={styles.mark}>
          <Ionicons name="person-outline" size={26} color={tokens.colors.fg} />
        </Animated.View>
        ...
        <Animated.Text entering={FadeInDown.delay(100).duration(300)} style={styles.subtitle}>
          You can round out your profile any time from the You tab — no rush.
        </Animated.Text>
      </View>
